...
DEFAULTS = {
    ...
    'swaps_per_round': 15,
    'log_level': 1,
    'offline_percent': 0.0 # offline_percent of the validators will be offline and not shuffle
}
...
if __name__ == '__main__':
    ...
    print("Params [width: {}, rounds: {}, swaps: {}]".format(args['width'], args['rounds'], args['swaps_per_round']))
